...
<html>
	<head>
		<?php echo $_imup["sharethis"]; ?><meta name="viewport" content="width=device-width, minimum-scale=0.1"><title><?php echo $f." | ".$_imup["title"]; ?></title>
		...
		<script type="text/javascript">
			function copyToClipboard(t) {
				...
				location.href = '<?php echo $_imup["baseurl"]; ?>'
			}
		</script>
	</head>
	<body style="margin: 0px; background: #0e0e0e;text-align: center;font-family: sans-serif;color:white;"><br>
		...
		<p>
			<?php echo $_imup["imageurl"]; ?> <a href="<?php echo $_imup["baseurl"]; ?>/<?php echo $f; ?>"><?php echo $_imup["baseurl"]; ?>/<?php echo $f; ?></a> <a href="#" id="copy" onclick="copyToClipboard('<?php echo $_imup["baseurl"]; ?>/<?php echo $f; ?>');return false;"><?php echo $_imup["copy"]; ?></a>
		</p>
